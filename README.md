...
- **54 tests** across unit (Money, installment split), repository (transfers, transactions,
...
Generated by [`tool/generate_branding.py`](tool/generate_branding.py) (requires Python 3 + Pillow):

| Asset | File | Size |
| --- | --- | --- |
| Banner (GitHub/social) | `docs/assets/banner.png` | 1200×630 |
| Logo | `docs/assets/logo.png` | 512×512 |
| App icon source | `docs/assets/icon.png` | 1024×1024 |

```bash
python3 tool/generate_branding.py   # regenerate all three images
```

To generate the full Android/iOS launcher icon set from `icon.png`, use
